    ...
    schema(
      {
        ...
        devin_mode: { type: "string", description: "Devin session mode. The swe-2-medium/high/max values select SWE-2 reasoning effort only; they do not select promo pricing/eligibility or a priority/fast service lane.", enum: ["normal", "fast", "lite", "ultra", "fusion", "swe-2-medium", "swe-2-high", "swe-2-max"] },
