...
This bootstrap is developer infrastructure, not a generic remote shell. It does not widen filesystem roots, bypass approvals, or alter the direct `execute` network prohibition. It remains available as the legacy CLI fallback described above.
