...
impl<'de> Deserialize<'de> for ActivityOperation {
        ...
        D: Deserializer<'de>,
    {
        ...
        match value.as_str() {
            ...
            "git_branch_create" => Ok(Self::GitBranchCreate),
            "git_branch_delete" => Ok(Self::GitBranchDelete),
            "git_remote_branch_delete" => Ok(Self::GitRemoteBranchDelete),
            "git_switch" => Ok(Self::GitSwitch),
            "git_worktree_add" => Ok(Self::GitWorktreeAdd),
            ...
            "github_pr_list" => Ok(Self::GithubPrList),
            "github_pr_get" => Ok(Self::GithubPrGet),
            "github_pr_close" => Ok(Self::GithubPrClose),
            ...
            "opencode_status" => Ok(Self::OpencodeStatus),
            "opencode_task_start" => Ok(Self::OpencodeTaskStart),
            "opencode_task_get" => Ok(Self::OpencodeTaskGet),
            "opencode_task_control" => Ok(Self::OpencodeTaskControl),
            "devin_status" => Ok(Self::DevinStatus),
            "devin_task_start" => Ok(Self::DevinTaskStart),
            "devin_task_get" => Ok(Self::DevinTaskGet),
            "devin_task_control" => Ok(Self::DevinTaskControl),
            "devin_cloud_status" => Ok(Self::DevinCloudStatus),
            "devin_cloud_task_start" => Ok(Self::DevinCloudTaskStart),
            "devin_cloud_task_get" => Ok(Self::DevinCloudTaskGet),
            "devin_cloud_task_control" => Ok(Self::DevinCloudTaskControl),
...
mod tests {
    ...
    fn serializes_all_fixed_enum_names() {
        let operations = [
            ...
            (ActivityOperation::GithubPrList, "github_pr_list"),
            (ActivityOperation::GithubPrGet, "github_pr_get"),
            (ActivityOperation::GithubPrClose, "github_pr_close"),
            ...
            (ActivityOperation::OpencodeStatus, "opencode_status"),
            (ActivityOperation::OpencodeTaskStart, "opencode_task_start"),
            (ActivityOperation::OpencodeTaskGet, "opencode_task_get"),
            (
                ActivityOperation::OpencodeTaskControl,
                "opencode_task_control",
            ),
            (ActivityOperation::DevinStatus, "devin_status"),
            (ActivityOperation::DevinTaskStart, "devin_task_start"),
            (ActivityOperation::DevinTaskGet, "devin_task_get"),
            (ActivityOperation::DevinTaskControl, "devin_task_control"),
            (ActivityOperation::DevinCloudStatus, "devin_cloud_status"),
            (
                ActivityOperation::DevinCloudTaskStart,
                "devin_cloud_task_start",
            ),
            (ActivityOperation::DevinCloudTaskGet, "devin_cloud_task_get"),
            (
