...
fn operation_name(operation: ActivityOperation) -> &'static str {
    match operation {
        ...
        ActivityOperation::OpencodeTaskControl => "opencode_task_control",
        ...
        ActivityOperation::DevinCloudTaskStart => "devin_cloud_task_start",
        ActivityOperation::DevinCloudTaskGet => "devin_cloud_task_get",
        ActivityOperation::DevinCloudTaskControl => "devin_cloud_task_control",
