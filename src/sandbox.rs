...
///
/// The pinned-worktree Git broker captures the canonical selected workspace and its
...
/// validated a workspace and carries it to the Git broker, so that later stage
/// compares against the exact identity that was validated instead of adopting
/// a freshly observed one.
